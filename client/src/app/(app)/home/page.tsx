"use client";
import { Table, Breadcrumb, Button, Pagination } from 'flowbite-react';
  ...
  return (
    <>
      <div className="flex flex-col p-4 h-full">
        ...
        <h1 className="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white mb-4">All products</h1>

        <div className="items-center justify-between block sm:flex md:divide-x md:divide-gray-100 dark:divide-gray-700 mb-4">
          ...
          <div className="flex whitespace-nowrap gap-2">
            ...
            <div className="flex items-center w-full sm:justify-end">
              <div className="flex pl-2 space-x-1">
                ...
                <a href="#" className="inline-flex justify-center p-1 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clipRule="evenodd"></path></svg>
                </a>
                <a href="#" className="inline-flex justify-center p-1 text-gray-500 rounded cursor-pointer hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
        ...
        <div className="flex flex-col grow overflow-x-auto bg-gray-800 justify-between">
          <Table className="border-b border-b-gray-700">
            <Table.Head>
              <Table.HeadCell className=''>Product name</Table.HeadCell>
          ...
          <Pagination
            className="flex md:flex-row flex-col md:justify-between items-center md:space-y-0 space-y-6 p-4"
            theme={{ pages: { base: 'xs:mt-0 flex items-center -space-x-px' } }}
            layout="table"
            currentPage={1}
            totalPages={100}
            onPageChange={() => { }}
